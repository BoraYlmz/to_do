...
screenx=(root.winfo_screenwidth()-rootx)/2
screeny=(root.winfo_screenheight()-rooty)/2
root.geometry('{0}x{1}+{2}+{3}'.format(rootx,rooty,int(screenx),int(screeny))) # set new geometry the + 75 + 75 is where it starts on the screen
# root.iconbitmap("icon.ico") # to show your own icon 
...
# buttob_image=PhotoImage(file="logo.png")
# title_bar_icon=Label(title_bar,image=buttob_image,bg=RGRAY,bd=0,highlightthickness=0)
title_bar_title = Label(title_bar, text=tk_title, bg=RGRAY,bd=0,fg='white',font=("calibri", 11,"bold"),highlightthickness=0)

# a frame for the main area of the window, this is where the actual app will go
window = Frame(root, bg=DGRAY,highlightthickness=1,highlightbackground=BGRAY)
...
title_bar_title.pack(side=LEFT, padx=0)
